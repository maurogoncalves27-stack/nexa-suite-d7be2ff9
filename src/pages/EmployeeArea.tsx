...
import MaintenanceConfirmAlert from "@/components/nutricontrol/MaintenanceConfirmAlert";
  ...
  return (
    <div className={`space-y-3 md:space-y-6 ${managerView ? "pb-6" : "pb-28 md:pb-6"}`}>
      ...
      <NoticesStack>
        ...
        />
        {/* Gestores/admins resolvem; estoquistas apenas visualizam e marcam como visto (gate interno). */}
        <MaintenanceRequestsAlert />
