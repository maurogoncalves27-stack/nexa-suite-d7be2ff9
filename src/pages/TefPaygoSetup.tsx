...
const AGENT_VERSION = "1.5.11";
const AGENT_EXE_URL = "https://nexasuite.aquelaparme.com.br/releases/NEXA-ACBr-Agent-Setup-1.5.11.exe";
            ...
            <div className="pt-1.5 border-t space-y-1.5">
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <Button
                  ...
                  size="sm"
                  className="h-6 text-[10px] gap-1"
                  title="Copia o caminho oficial dos logs do PayGo Windows (C:\PAYGOWEB\Log) — cole no Explorer"
                  onClick={() => copy("C:\\PAYGOWEB\\Log", "Caminho da pasta de logs")}
                >
