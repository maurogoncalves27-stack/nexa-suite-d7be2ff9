...
// placeIds oficiais do Google Maps de cada loja.
// reviewUrl() monta a URL direta do formulário de avaliação (não usa g.page,
// que pode ser bloqueado por algumas redes corporativas/DNS).
const BRANDS: Brand[] = [
  {
    id: "parme",
    name: "Aquela Parmê",
