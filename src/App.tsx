...
import { startKioskSessionKeeper } from "@/lib/kioskSession";
...
const ProductsFactory = lazy(() => import("./pages/ProductsFactory.tsx"));
          ...
          <Routes>
            ...
            */}
            <Route element={<AppLayout />}>
              ...
              <Route path="/clima" element={<Guarded><Climate /></Guarded>} />
              <Route path="/clima-organizacional" element={<Navigate to="/saude-ocupacional?tab=clima" replace />} />
              ...
              {/* Base da Giana foi unificada no CRM › Agente IA */}
              <Route path="/configuracoes/giana" element={<Navigate to="/crm" replace />} />
              ...
              <Route path="/fatores-conversao" element={<Guarded staff><ConversionFactors /></Guarded>} />
