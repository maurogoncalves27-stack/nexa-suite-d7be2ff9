...
const pdvSections: Section[] = [
  { label: "Operação", items: [
    ...
    { title: "Homologação PayGo", url: "/pdv-novo/homologacao-paygo", icon: ClipboardCheck, staffOnly: true },
