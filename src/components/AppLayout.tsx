...
const PAGE_TITLES: PageMeta[] = [
  ...
  { match: (p) => p.startsWith("/pccs"), title: "Plano de Carreira (PCCS)", group: "Desempenho" },
  ...
  { match: (p) => p.startsWith("/plano-fabrica"), title: "Plano semanal do Centro de Distribuição", group: "Estoque" },
  ...
  { match: (p) => p.startsWith("/produtos-fabrica"), title: "Produtos do Centro de Distribuição", group: "CD" },
  ...
  { match: (p) => p.startsWith("/receituario-fabrica"), title: "Receituário", group: "CD" },
  ...
  { match: (p) => p.startsWith("/configuracoes/giana"), title: "Base da Giana", group: "Configurações" },
  ...
  { match: (p) => p.startsWith("/configuracoes/tef"), title: "TEF", group: "PDV" },
  { match: (p) => p.startsWith("/configuracoes/smartpos"), title: "TEF", group: "PDV" },
  ...
  { match: (p) => p.startsWith("/configuracoes/hardcodes"), title: "Mapa de hardcodes", group: "Configurações" },
  { match: (p) => p.startsWith("/configuracoes/alertas"), title: "Alertas e notificações", group: "Configurações" },
